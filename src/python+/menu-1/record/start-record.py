...
class Support_Ui_Dialog:
    ...
    def __init__(self,main_self):
        ...
        self.main_self.start_record_window.showMaximized()
        self.main_self.start_record_window.update()
        
        self.main_self.start_record_window.closeEvent = lambda event:self.closeEvent(event)
        
    def closeEvent(self,event):
        self.main_self.start_record_window_is_open = False
        event.accept()        
