...
class Support_Ui_Dialog:
    ...
    def __init__(self,main_self):
        ...
        self.main_self.import_sound_file_from_sound_file_window.closeEvent = lambda event:self.closeEvent(event)
        
    def closeEvent(self,event):
        self.main_self.import_sound_file_from_sound_file_window_is_open = False
        event.accept()        
