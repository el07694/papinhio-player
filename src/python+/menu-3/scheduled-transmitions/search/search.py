...
class Support_Ui_Dialog:
    ...
    def __init__(self,main_self,action,relative_type,relative_number):
        ...
        self.main_self.search_schedule_transmitions_window.closeEvent = lambda event:self.closeEvent(event)
        
    def closeEvent(self,event):
        self.main_self.search_schedule_transmitions_window_is_open = False
        event.accept()        
