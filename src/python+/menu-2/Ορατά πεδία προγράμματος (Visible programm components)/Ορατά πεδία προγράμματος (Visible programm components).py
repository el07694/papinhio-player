...
class Support_Ui_Dialog:
    ...
    def __init__(self,main_self):
        ...
        #change manage_radio_connections_window to apply the correct window
    ...
    def save_finished(self):
        self.main_self.programm_components_queue.put({"type":"programm_components"})
    ...
    def closeEvent(self,event):
        ...
        if self.need_save == False:
            ...
            self.need_save = False
            self.main_self.visible_programm_components_window_is_open = False
            event.accept()
        else:
            event.ignore()
