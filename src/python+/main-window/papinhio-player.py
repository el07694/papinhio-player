...
### programm components class ###
programm_components = importlib.import_module("python+.main-window.program-components")
...
class Papinhio_player:
    ...
    def __init__(self):
		...
		#programm components
        self.programm_components = programm_components.Programm_Components(self)        
    ...
    def closeEvent(self,event):
        ...
        self.programm_components.programm_components_emitter.terminate()
        self.programm_components.programm_components_child_process.terminate()
            

        counter = 0
        for process in self.manage_processes_instance.processes:
            if "process_number" in process:
                if process["process_number"]==self.manage_player_list_table_instance.proccess_number or process["process_number"]==self.programm_components.programm_components_proccess_number:
