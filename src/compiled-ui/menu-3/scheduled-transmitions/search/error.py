...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/search/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία αναζήτησης προγραμματισμένων μετάδοσεων"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την αναζήτηση προγραμματισμένων μετάδοσεων.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας αναζήτησης προγραμματισμένων μετάδοσεων."))
import sys
sys.path.append('../../../')
