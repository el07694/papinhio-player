...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/at-least-one-day-of-week-selected.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Δεν έχετε επιλέξει μέρα (ή ημέρες) της εβδομάδος για τις οποίες επιθυμείτε την έναρξη της προγραμματισμένης μετάδοσης. Επιλέξτε τουλάχιστον μία ημέρα (από τις διαθέσιμες 7) και συνεχίστε στην καρτέλα 3."))
