...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/at-least-one-month-of-year.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Δεν έχετε επιλέξει κανένα μήνα (Ιανουάριος έως Δεκέμβριος) για τους οποίους επιθυμείτε την έναρξη της προγραμματισμένης μετάδοσης. Επιλέξτε τουλάχιστον ένα μήνα (από τους διαθέσιμους) και συνεχίστε στην καρτέλα 3."))
