...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/time-settings-for-weather-news.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Θα πρέπει να εισάγετε τις χρονικές παραμέτρους για το προεπιλεγμένο δελτίο καιρού."))
