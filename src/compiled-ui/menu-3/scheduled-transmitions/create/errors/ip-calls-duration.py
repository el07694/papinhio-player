...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/ip-calls-duration.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διάρκεια των ηχητικών κλήσεων"))
        self.label.setText(_translate("Dialog", "Η διάρκεια την ηχητικών κλήσεων θα πρέπει να είναι μεγαλύτερη του μηδέν και μικρότερη της διάρκειας της ζωντανής εκπομπής."))
