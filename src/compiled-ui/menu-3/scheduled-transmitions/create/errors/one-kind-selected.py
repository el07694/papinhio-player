...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/one-kind-selected.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Δεν έχετε επιλέξει κανένα είδος μετάδοσης. Επιλέξτε τουλάχιστον ένα είδος μετάδοσης και έπειτα συνεχίστε στην καρτέλα 4."))
