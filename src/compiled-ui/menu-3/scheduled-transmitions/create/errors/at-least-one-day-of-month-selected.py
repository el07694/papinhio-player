...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/at-least-one-day-of-month-selected.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Δεν έχετε επιλέξει καμία ημέρα του μήνα (1-31) για τις οποίες επιθυμείτε την έναρξη της προγραμματισμένης μετάδοσης. Επιλέξτε τουλάχιστον μία ημέρα (από τις διαθέσιμες 1 - 31) και συνεχίστε στην καρτέλα 3."))
