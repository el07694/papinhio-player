...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/start-datetime-greater-than-today.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Λάθος ημερομηνία έναρξης"))
        self.label.setText(_translate("Dialog", "Η ημερομηνία και ώρα έναρξης δεν μπορεί να είναι μικρότερης της τρέχουσας ημερομηνίας και ώρας. Παρακαλώ διορθώστε την ημερομηνία έναρξης και συνεχίστε στην καρτέλα 3."))
