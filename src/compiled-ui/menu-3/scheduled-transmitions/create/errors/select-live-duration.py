...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/select-live-duration.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Παρακαλώ εισάγετε την διάρκεια της ζωντανής εκπομπής (καρτέλα 2) και έπειτα συνεχίστε στην καρτέλα 3."))
