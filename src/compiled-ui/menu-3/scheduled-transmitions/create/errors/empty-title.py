...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/empty-title.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Ο τίτλος της προγραμματισμένης μετάδοσης δεν μπορεί να είναι κενός. Παρακαλώ εισάγετε μοναδικό τίτλο προγραμματισμένης μετάδοσης και συνεχίστε στην καρτέλα 2."))
