...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/unique-title.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Μη αποδεκτός τίτλος προγραμματισμένης μετάδοσης"))
        self.label.setText(_translate("Dialog", "Ο τίτλος της προγραμματισμένης μετάδοσης που επιλέξατε (\"...\") δεν μπορεί να χρησιμοποιηθεί διότι έχει εισαχθεί ήδη σε άλλη προγραμματισμένη μετάδοση. Παρακαλώ εισάγετε μοναδικό τίτλο προγραμματισμένης μετάδοσης και συνεχίστε στην καρτέλα 2."))
