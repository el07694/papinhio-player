...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/select-main-frequency.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Δεν έχετε επιλέξει περίοδο επανάληψης. Επιλέξτε περίοδο επανάληψης, εισάγετε τα δεδομένα που θα σας ζητηθούν και συνεχίστε στην καρτέλα 3."))
