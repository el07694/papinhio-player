...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/contact-details.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Τα στοιχεία επικοινωνίας (Όνομα εκφωνητή, τηλέφωνο επικοινωνίας και e-mail πρέπει να είναι συμπληρωμένα). Συμπληρώστε τα ορθά και συνεχίστε στην καρτέλα 2"))
