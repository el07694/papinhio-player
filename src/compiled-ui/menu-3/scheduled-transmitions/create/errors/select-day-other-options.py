...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/select-day-other-options.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Έχετε επιλέξει την Επιλογή άλλο (στις Επαναλήψεις) αλλά δεν έχετε καθορίσει την περίοδο επανάληψης. Εισάγετε την περίοδο επανάληψης στην επιλογή Άλλο, και έπειτα συνεχίστε στην καρτέλα 3."))
