...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/end-datetime-greater-start-datetime.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Λάθος ημερομηνία λήξης"))
        self.label.setText(_translate("Dialog", "Η ημερομηνία και ώρα λήξης δεν μπορεί να είναι μικρότερη της ημερομηνίας και ώρας έναρξης. Παρακαλώ διορθώστε την ημερομηνία λήξης ή την ημερομηνία έναρξης και συνεχίστε στην καρτέλα 3."))
