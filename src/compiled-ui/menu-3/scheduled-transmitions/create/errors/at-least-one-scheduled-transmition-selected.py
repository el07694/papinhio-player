...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/at-least-one-scheduled-transmition-selected.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Δεν έχετε επιλέξει καμία προγραμματισμένη μετάδοση στο τέλος της οποίας επιθυμείτε την έναρξη της νέας προγραμματισμένης μετάδοσης. Επιλέξτε τουλάχιστον μία προγραμματισμένη μετάδοση (από τις διαθέσιμες) και συνεχίστε στην καρτέλα 3."))
