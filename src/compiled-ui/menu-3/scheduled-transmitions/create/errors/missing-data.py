...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/scheduled-transmitions/create/errors/missing-data.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Στην καρτέλα 3 έχετε επιλέξει ως είδος μετάδοσης \"...\", αλλά δεν πραγματοποιήθηκε καμία εισαγωγή \"...\" στην προγραμματισμένη μετάδοση. Εισάγετε κάποιο ηχητικό δεδομένο για αυτό το είδος ή μεταβείτε στην καρτέλα 3 ώστε να καταργήσετε αυτό το είδος αν τελικά δεν επιθυμείτε να το συμπεριλάβετε στην προγραμματισμένη μετάδοση."))
