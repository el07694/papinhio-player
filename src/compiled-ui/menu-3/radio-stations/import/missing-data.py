...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/radio-stations/import/missing-data.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Παρακαλώ εισάγετε τα ελλιπή δεδομένα και έπειτα προσπαθήστε ξανά."))
