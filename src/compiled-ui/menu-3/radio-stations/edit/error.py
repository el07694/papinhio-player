...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-3/radio-stations/edit/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία Επεξεργασίας ραδιοφωνικής σύνδεσης"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την Επεξεργασία ραδιοφωνικής σύνδεσης.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας Επεξεργασία ραδιοφωνικής σύνδεσης."))
import sys
sys.path.append('../../../')
