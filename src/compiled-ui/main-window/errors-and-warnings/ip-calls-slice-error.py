...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/main-window/errors-and-warnings/ip-calls-slice-error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Λάθος διεργασίας ηχητικών κλήσεων"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label.setText(_translate("Dialog", "Προέκυψε σφάλμα στην διεργασία ηχητικών κλήσεων.\n"
"Λεπτομέρειες:"))
        self.label_2.setText(_translate("Dialog", "Θα γίνει απόπειρα επανεκκίνησης της διεργασίας ηχητικών κλήσεων."))
import sys
sys.path.append('../../')
