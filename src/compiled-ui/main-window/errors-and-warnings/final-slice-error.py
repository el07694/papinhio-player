...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/main-window/errors-and-warnings/final-slice-error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Λάθος τελικού σήματος εξόδου"))
        self.label.setText(_translate("Dialog", "Προέκυψε σφάλμα κατά την δημιουργία του τελικού σήματος εξόδου.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα γίνει απόπειρα επανεκκίνησης της διεργασίας που δημιουργεί το τελικό σήμα εξόδου."))
import sys
sys.path.append('../../')
