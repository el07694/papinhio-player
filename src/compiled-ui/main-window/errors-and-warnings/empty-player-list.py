...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/main-window/errors-and-warnings/empty-player-list.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Εισάγετε δεδομένα"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label.setText(_translate("Dialog", "Η λίστα αναπαραγωγής του main player άδειασε. \n"
"Παρακαλώ εισάγετε δεδομένα στην λίστα αναπαραγωγής του main player."))
import sys
sys.path.append('../../')
