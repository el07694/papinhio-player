...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/sound-clips/import/wrong-file-type.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/main-window/assets/images/main-window/sound-clip.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.choose_another_file.setIcon(icon2)
        self.choose_another_file.setObjectName("choose_another_file")
        self.gridLayout.addWidget(self.choose_another_file, 2, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Λάθος τύπος αρχείου"))
        ...
        self.choose_another_file.setText(_translate("Dialog", "Επιλογή άλλου ηχητικού clip"))
import sys
sys.path.append('../../../')
