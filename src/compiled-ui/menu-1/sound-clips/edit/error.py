...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/sound-clips/edit/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία επεξεργασίας ηχητικών clips"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την επεξεργασία των ηχητικών clips.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας επεξεργασίας ηχητικών clips."))
import sys
sys.path.append('../../../')
