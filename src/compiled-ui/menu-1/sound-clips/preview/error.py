...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/sound-clips/preview/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία προεπισκόπησης ηχητικών clips"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την προεπισκόπηση των ηχητικών clips.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας προεπισκόπησης ηχητικών clips."))
import sys
sys.path.append('../../../')
