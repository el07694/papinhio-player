...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/church-news/edit/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία επεξεργασίας δελτίου εκκλησιαστικών ανακοινώσεων"))
        self.label.setText(_translate("Dialog", "Προέκυψε σφάλμα κατά την επεξεργασία του δελτίου εκκλησιαστικών ανακοινώσεων.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας επεξεργασίας δελτίου εκκλησιαστικών ανακοινώσεων."))
import sys
sys.path.append('../../../../')
