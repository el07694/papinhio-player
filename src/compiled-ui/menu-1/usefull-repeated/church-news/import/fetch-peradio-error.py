...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/church-news/import/fetch-peradio-error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Αδυναμία εύρεσης δελτίου εκκλησιαστικών ανακοιώσεων από peradio.com"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label.setText(_translate("Dialog", "Δεν κατέστει δυνατό η εύρεση δελτίου εκκλησιαστικών ανακοινώσεων από τον ιστότοπο peradio.com"))
import sys
sys.path.append('../../../../')
