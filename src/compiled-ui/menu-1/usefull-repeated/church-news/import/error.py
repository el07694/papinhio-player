...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/church-news/import/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία εισαγωγής δελτίου εκκλησιαστικών ανακοινώσεων"))
        self.label.setText(_translate("Dialog", "Προεκυψε σφάλμα κατά την εισαγωγή του δελτίου εκκλησιαστικών ανακοινώσεων.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας εισαγωγής δελτίου εκκλησιαστικών ανακοινώσεων."))
import sys
sys.path.append('../../../../')
