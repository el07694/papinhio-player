...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/church-news/import/wrong-file-type.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/main-window/assets/images/main-window/church.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Λάθος αρχείο ήχου"))
        self.choose_another_file.setText(_translate("Dialog", "Επιλογή άλλου αρχείου ήχου (δελτίου εκκλησιαστικών ανακοινώσεων)"))
