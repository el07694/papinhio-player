...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/Greece-time/preview/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία προεπισκόπησης συλλογής Ώρας Ελλάδας"))
        self.label.setText(_translate("Dialog", "Προέκυψε σφάλμα κατά την προεπισκόπησης συλλογής Ώρας Ελλάδας.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας προεπισκόπησης συλλογής Ώρας Ελλάδας."))
import sys
sys.path.append('../../../../')
