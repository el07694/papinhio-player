...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/station-logos/search/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία αναζήτησης σήματος σταθμού"))
        self.label.setText(_translate("Dialog", "Προέκυψε σφάλμα κατά την αναζήτηση σήματος σταθμού.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας αναζήτησης σήματος σταθμού."))
import sys
sys.path.append('../../../../')
