...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/station-logos/export/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Προέκυψε σφάλμα κατά την εξαγωγή σήματος σταθμού.\n"
"Λεπτομέρειες:"))
