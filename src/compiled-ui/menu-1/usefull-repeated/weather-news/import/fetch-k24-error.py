...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/weather-news/import/fetch-k24-error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Αδυναμία εύρεσης δελτίου καιρού από k24.gr"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label.setText(_translate("Dialog", "Δεν κατέστει δυνατό η εύρεση δελτίου καιρού από τον ιστότοπο k24.gr"))
import sys
sys.path.append('../../../../')
