...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/weather-news/import/wrong-file-type.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/main-window/assets/images/main-window/weather.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.choose_another_file.setText(_translate("Dialog", "Επιλογή άλλου αρχείου ήχου (δελτίου καιρού)"))
