...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/usefull-repeated/weather-news/edit/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία επεξεργασίας δελτίου καιρού"))
        self.label.setText(_translate("Dialog", "Προέκυψε σφάλμα κατά την επεξεργασία του δελτίου καιρού.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας επεξεργασίας δελτίου καιρού."))
import sys
sys.path.append('../../../../')
