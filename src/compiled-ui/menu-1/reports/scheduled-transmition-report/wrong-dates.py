...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/reports/scheduled-transmition-report/wrong-dates.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Λάθος ημερομηνίες"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label.setText(_translate("Dialog", "Η ημερομηνία έναρξης (../../...) δεν μπορεί να είναι μεγαλύτερη ή ίση της ημερομηνίας λήξης (../../....). Διορθώστε τις ημερομηνίες και προσπαθήστε ξανά."))
import sys
sys.path.append('../../../')
