...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/reports/player-history-report/error.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/rest-windows/assets/images/rest-windows/report-history.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία δημιουργίας αναφοράς \"Ιστορικού μεταδόσεων\""))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την δημιουργία της αναφοράς \"Ιστορικό μεταδόσεων\".\n"
"Λεπτομέρειες:"))
