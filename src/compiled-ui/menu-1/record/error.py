...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/record/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία της ηχογράφησης"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την ηχογράφηση του ραδιοφωνικού προγράμματος.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Δεν θα πραγματοποιηθεί καμία ενέργεια.\n"
"Παρακαλώ ελέγξε το φάκελο που περιέχει τα αρχεία της ηχογράφησης για να βεβαιωθείτε\n"
"ότι δεν υπάρχει απώλεια δεδομένων."))
import sys
sys.path.append('../../')
