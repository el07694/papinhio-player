...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/playlists/edit/not-empty.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Το περιεχόμενο της λίστας αναπαραγωγής δεν μπορεί να είναι κενό. Παρακαλώ εισάγετε δεδομένα και προσπαθήστε ξανά."))
