...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/playlists/edit/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα κατά την επεξεργασία λίστας αναπαραγωγής"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την επεξεργασία υπαρχούσης λίστας αναπαραγωγής.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα πραγματοποιηθεί απόπειρα επανεκκίνησης της διεργασίας επεξεργασίας υπαρχούσης λίστας αναπαραγωγής (πιθανή απώλεια δεδομένων)."))
import sys
sys.path.append('../../../')
