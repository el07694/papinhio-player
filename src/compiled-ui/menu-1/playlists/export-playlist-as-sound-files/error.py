...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/playlists/export-playlist-as-sound-files/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την εξαγωγή υπαρχούσης λίστας αναπαραγωγής ως αρχεία ήχου.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα πραγματοποιηθεί απόπειρα επανεκκίνησης της διεργασίας εξαγωγής υπαρχούσης λίστας αναπαραγωγής ως αρχεία ήχου."))
import sys
sys.path.append('../../../')
