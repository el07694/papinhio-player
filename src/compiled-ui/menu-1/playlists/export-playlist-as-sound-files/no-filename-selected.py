...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/playlists/export-playlist-as-sound-files/no-filename-selected.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Δεν έχει επιλεγεί τίτλος σήματος σταθμού"))
        self.label.setText(_translate("Dialog", "Παρακαλώ επιλέξτε ένα τίτλο σήματος σταθμού και προσπαθήστε ξανά."))
