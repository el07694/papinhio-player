...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/playlists/export-playlist-as-playlist/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα κατά την εξαγωγή λίστας αναπαραγωγής"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την εξαγωγή υπαρχούσης λίστας αναπαραγωγής ως λίστα αναπαραγωγής.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα πραγματοποιηθεί απόπειρα επανεκκίνησης της διεργασίας εξαγωγής υπαρχούσης λίστας αναπαραγωγής ως λίστα αναπαραγωγής."))
import sys
sys.path.append('../../../')
