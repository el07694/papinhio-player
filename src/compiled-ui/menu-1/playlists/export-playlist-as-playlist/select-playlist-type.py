...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/playlists/export-playlist-as-playlist/select-playlist-type.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Δεν έχει επιλογή τύπος playlist"))
        self.label.setText(_translate("Dialog", "Παρακαλώ επιλέξτε ένα τύπο λίστας αναπαραγωγής και προσπαθήστε ξανά."))
