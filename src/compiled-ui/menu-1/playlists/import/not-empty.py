...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/playlists/import/not-empty.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Το περιεχόμενο της λίστας αναπαραγωγής είναι κενό. Για τον λόγο αυτό δεν εισάγετε η λίστα αναπαραγωγής (ελλιπή δεδομένα)."))
