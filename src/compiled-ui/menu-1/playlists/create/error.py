...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/playlists/create/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα κατά την δημιουργία λίστας αναπαραγωγής"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την δημιουργία νέας λίστας αναπαραγωγής.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα πραγματοποιηθεί απόπειρα επανεκκίνησης της διεργασίας δημιουργίας νέας λίστας αναπαραγωγής (πιθανή απώλεια δεδομένων)."))
import sys
sys.path.append('../../../')
