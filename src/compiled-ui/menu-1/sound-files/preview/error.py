...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/sound-files/preview/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία προεπισκόπησης αρχείου ήχου"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την προεπισκόπηση του αρχείου ήχου.\n"
"Λεπτομέρειες:"))
