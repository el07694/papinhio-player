...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/sound-files/import-sound-file-from-sound-file/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία εισαγωγής αρχείου ήχου"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την εισαγωγή του αρχείου ήχου.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας εισαγωγής αρχείου ήχου."))
import sys
sys.path.append('../../../')
