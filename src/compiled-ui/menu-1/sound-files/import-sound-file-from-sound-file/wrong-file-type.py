...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/sound-files/import-sound-file-from-sound-file/wrong-file-type.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/rest-windows/assets/images/rest-windows/sound-files.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.choose_another_file.setText(_translate("Dialog", "Επιλογή άλλου αρχείου ήχου"))
