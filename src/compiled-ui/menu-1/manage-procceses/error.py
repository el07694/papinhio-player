...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/manage-procceses/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα κατά την διαχείριση και προβολή των διεργασιών"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την διαχείριση και προβολή των διεργασιών.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα πραγματοποιηθεί απόπειρα επανεκκίνησης του προγράμματος (ενδεχόμενη απώλεια δεδομένων)."))
import sys
sys.path.append('../../')
