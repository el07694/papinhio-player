...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/retransmitions/import/error.ui'
#
...
"Λεπτομέρειες:"))
        ...
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας εισαγωγής αναμετάδοσης."))
import sys
sys.path.append('../../../')
