...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/retransmitions/import/not-empty.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Παρακαλώ συμπληρώστε όλα τα δεδομένα της φόρμας και προσπαθήστε ξανά."))
