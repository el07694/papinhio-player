...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/retransmitions/export/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία εξαγωγής αναμετάδοσης"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την εξαγωγή αναμετάδοσης σε αρχείο playlist.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας εξαγωγής αναμετάδοσης."))
import sys
sys.path.append('../../../')
