...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/manage-input-and-output-sound-devices/microphone-input-device-settings/error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα κατά την ρύθμιση μικροφώνου"))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την ρύθμιση του μικροφώνου.\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα πραγματοποιηθεί απόπειρα επανεκκίνησης της διεργασίας ρύθμισης μικροφώνου."))
import sys
sys.path.append('../../../')
