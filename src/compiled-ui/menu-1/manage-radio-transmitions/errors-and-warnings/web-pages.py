...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/manage-radio-transmitions/errors-and-warnings/web-pages.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σελίδες ακρόασης"))
        self.label.setText(_translate("Dialog", "Η σελίδα ακρόασης: ... δεν είναι προσβάσιμη.\n"
"Λεπτομέρειες:"))
