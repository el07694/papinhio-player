...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-1/manage-radio-transmitions/errors-and-warnings/timeline-graph-error.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα γραφικής παράστασης"))
        self.label.setText(_translate("Dialog", "Προέκυψε σφάλμα κατά την δημιουργία της γραφικής παράστασης\n"
"της ραδιοφωνικής σύνδεσης ...\n"
"Λεπτομέρειες:"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα γίνει απόπειρα επανεκκίνησης της διεργασίας των γραφικών παραστάσεων."))
import sys
sys.path.append('../../../')
