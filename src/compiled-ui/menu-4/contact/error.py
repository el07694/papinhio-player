...
# Form implementation generated from reading ui file '/home/chris/Documents/papinhio-player/ui/menu-4/contact/error.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.details.setStyleSheet("QPlainTextEdit{border:1px solid #ABABAB;}")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Σφάλμα στην διεργασία Αποστολής μηνύματος"))
        self.ok.setText(_translate("Dialog", "Εντάξει"))
        self.label_2.setText(_translate("Dialog", "Θα επιχειρηθεί επανεκκίνηση της διεργασίας αποστολής μηνύματος αν επιθυμήσετε κάτι τέτοιο."))
        self.label.setText(_translate("Dialog", "Προεύκυψε σφάλμα κατά την Αποστολή μηνύματος.\n"
"Λεπτομέρειες:"))
