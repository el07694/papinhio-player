...
def import_Greece_time_collections():
	...
	saved_paths = []
	image_paths = []
	directory_folder = os.path.abspath("../../disket-box/Greece-time-files/"+str(group_title))
	os.makedirs(directory_folder)
	for i in range(1,13):
		original_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/case-1/"+str(i)+".mp3")
		saved_path = directory_folder+"/"+str(i)+".mp3"
		if i<10:
			when_to_play = "0"+str(i)+":00|"+str(i+12)+":00"
			image_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/images/clock-0"+str(i)+".png")
		else:
			when_to_play = str(i)+":00|"+str(i+12)+":00"
			image_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/images/clock-"+str(i)+".png")			
	...
	os.makedirs(directory_folder)
	for i in range(1,25):
		original_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/case-2/"+str(i)+".mp3")
		saved_path = directory_folder+"/"+str(i)+".mp3"
		if i<10:
			...
			if j<10:
				j = "0"+str(j)
			image_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/images/clock-"+str(j)+".png")			
		original_paths.append(original_path)
		saved_paths.append(saved_path)
		image_paths.append(image_path)
	...
	os.makedirs(directory_folder)
	for i in range(1,13):
		original_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/case-3/"+str(i)+".mp3")
		saved_path = directory_folder+"/"+str(i)+".mp3"
		if i<10:
			when_to_play = "0"+str(i)+":00|"+str(i+12)+":00"
			image_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/images/clock-0"+str(i)+".png")
		...
		original_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/case-3/"+str(i)+"-30.mp3")
		saved_path = directory_folder+"/"+str(i)+"-30.mp3"
		if i<10:
			when_to_play = "0"+str(i)+":30|"+str(i+12)+":30"
			image_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/images/clock-0"+str(i)+"-30.png")
		else:
			when_to_play = str(i)+":30|"+str(i+12)+":30"
			image_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/images/clock-"+str(i)+"-30.png")		   
		original_paths.append(original_path)
		saved_paths.append(saved_path)
		image_paths.append(image_path)
	...
	time_items = []
	for i in range(1,25):
		original_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/case-4/"+str(i)+".mp3")
		saved_path = directory_folder+"/"+str(i)+".mp3"
		if i<10:
			when_to_play = "0"+str(i)+":00"
			image_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/images/clock-0"+str(i)+".png")
		...
		original_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/case-4/"+str(i)+"-30.mp3")
		saved_path = directory_folder+"/"+str(i)+"-30.mp3"
		if i<10:
			...
			if j<10:
				j = "0"+str(j)
			image_path = os.path.abspath("../../disket-box/test-contents/Greece-time-files/images/clock-"+str(j)+"-30.png")		   
		original_paths.append(original_path)
		saved_paths.append(saved_path)
		image_paths.append(image_path)
